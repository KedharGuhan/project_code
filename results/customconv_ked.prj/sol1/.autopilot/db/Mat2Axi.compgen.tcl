...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler Filter2d_accel_fifo_w64_d4_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {dout_c_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler Filter2d_accel_fifo_w15_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {p_channel_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler Filter2d_accel_fifo_w15_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {axibound_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler Filter2d_accel_fifo_w8_d2_S_x BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {ldata_U}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { imgOutput_data_dout { I 8 vector } imgOutput_data_empty_n { I 1 bit } imgOutput_data_read { O 1 bit } } \
} "
}
