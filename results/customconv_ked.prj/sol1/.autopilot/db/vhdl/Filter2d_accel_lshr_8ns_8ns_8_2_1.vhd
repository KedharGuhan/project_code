...
entity Filter2d_accel_lshr_8ns_8ns_8_2_1 is
    generic (
      ID         : INTEGER := 1;                            --core ID,       unused in RTL
      din0_WIDTH : INTEGER := 8;                 --data bitwidth
      din1_WIDTH : INTEGER := 8;                 --shift control bitwidth
      dout_WIDTH : INTEGER := 8;                 --output bitwidth
...
end entity Filter2d_accel_lshr_8ns_8ns_8_2_1;
architecture rtl of Filter2d_accel_lshr_8ns_8ns_8_2_1 is
