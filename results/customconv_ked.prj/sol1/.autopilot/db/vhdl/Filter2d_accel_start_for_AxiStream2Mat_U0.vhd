...
entity Filter2d_accel_start_for_AxiStream2Mat_U0 is 
    generic (
...
architecture rtl of Filter2d_accel_start_for_AxiStream2Mat_U0 is

    component Filter2d_accel_start_for_AxiStream2Mat_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_Filter2d_accel_start_for_AxiStream2Mat_U0_ShiftReg : Filter2d_accel_start_for_AxiStream2Mat_U0_ShiftReg
    generic map (
...
entity Filter2d_accel_start_for_AxiStream2Mat_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end Filter2d_accel_start_for_AxiStream2Mat_U0_ShiftReg;

architecture rtl of Filter2d_accel_start_for_AxiStream2Mat_U0_ShiftReg is
