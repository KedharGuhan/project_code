set moduleName xfMat2Array_8_0_128_128_1_2_1_s
set isTopModule 0
...
set C_modelName {xfMat2Array<8, 0, 128, 128, 1, 2, 1>}
...
set C_modelArgList {
	...
	{ conv_out_c int 64 regular {fifo 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "p_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "conv_out","offset": { "type": "dynamic","port_name": "conv_out","bundle": "control_r"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "dstPtr", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "conv_out_c", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ imgOutput_data_dout sc_in sc_lv 8 signal 2 } 
	{ imgOutput_data_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ imgOutput_data_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ imgOutput_data_empty_n sc_in sc_logic 1 signal 2 } 
	{ imgOutput_data_read sc_out sc_logic 1 signal 2 } 
	...
	{ m_axi_gmem2_WDATA sc_out sc_lv 8 signal 3 } 
	{ m_axi_gmem2_WSTRB sc_out sc_lv 1 signal 3 } 
	...
	{ m_axi_gmem2_RDATA sc_in sc_lv 8 signal 3 } 
	{ m_axi_gmem2_RLAST sc_in sc_logic 1 signal 3 } 
	{ m_axi_gmem2_RID sc_in sc_lv 1 signal 3 } 
	{ m_axi_gmem2_RFIFONUM sc_in sc_lv 11 signal 3 } 
	...
	{ conv_out_c_din sc_out sc_lv 64 signal 5 } 
	{ conv_out_c_num_data_valid sc_in sc_lv 3 signal 5 } 
	{ conv_out_c_fifo_cap sc_in sc_lv 3 signal 5 } 
	{ conv_out_c_full_n sc_in sc_logic 1 signal 5 } 
	{ conv_out_c_write sc_out sc_logic 1 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "conv_out_c_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "conv_out_c", "role": "din" }} , 
 	{ "name": "conv_out_c_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "conv_out_c", "role": "num_data_valid" }} , 
 	{ "name": "conv_out_c_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "conv_out_c", "role": "fifo_cap" }} , 
 	{ "name": "conv_out_c_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "conv_out_c", "role": "full_n" }} , 
 	{ "name": "conv_out_c_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "conv_out_c", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "imgOutput_data", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Mat2Axi_fu_74", "Port" : "imgOutput_data", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Mat2Axi_fu_74", "Port" : "gmem2", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			...
			{"Name" : "conv_out_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "conv_out_c_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74", "Parent" : "0", "Child" : ["2", "3", "5", "6", "19", "22", "23", "24", "25"],
		"CDFG" : "Mat2Axi",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		...
		"IsBlackBox" : "0",
		"InputProcess" : [
			{"ID" : "2", "Name" : "entry_proc6_U0"},
			{"ID" : "3", "Name" : "addrbound_U0"},
			{"ID" : "6", "Name" : "Mat2AxiStream_U0"}],
		"OutputProcess" : [
			{"ID" : "19", "Name" : "AxiStream2Axi_U0"}],
		"Port" : [
			{"Name" : "imgOutput_data", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "Mat2AxiStream_U0", "Port" : "imgOutput_data"}]},
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "19", "SubInstance" : "AxiStream2Axi_U0", "Port" : "gmem2"}]},
			{"Name" : "dout", "Type" : "None", "Direction" : "I"},
			{"Name" : "rows", "Type" : "None", "Direction" : "I"},
			{"Name" : "cols", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.entry_proc6_U0", "Parent" : "1",
		"CDFG" : "entry_proc6",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "dout", "Type" : "None", "Direction" : "I"},
			{"Name" : "dout_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["19"], "DependentChan" : "22", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "dout_c_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.addrbound_U0", "Parent" : "1", "Child" : ["4"],
		"CDFG" : "addrbound",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "p_channel", "Type" : "None", "Direction" : "O", "DependentProc" : ["5"], "DependentChan" : "23", "DependentChanDepth" : "2", "DependentChanType" : "1"},
			{"Name" : "rows", "Type" : "None", "Direction" : "I"},
			{"Name" : "cols", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "4", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.addrbound_U0.mul_15s_15s_15_3_1_U176", "Parent" : "3"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.Mat2Axi_Block_entry24_proc_U0", "Parent" : "1",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "axibound_1", "Type" : "None", "Direction" : "I", "DependentProc" : ["3"], "DependentChan" : "23", "DependentChanDepth" : "2", "DependentChanType" : "1"}]},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.Mat2AxiStream_U0", "Parent" : "1", "Child" : ["7", "8", "9", "16", "17", "18"],
		"CDFG" : "Mat2AxiStream",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "Dataflow", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "1",
		...
		"Port" : [
			{"Name" : "imgOutput_data", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "9", "SubInstance" : "MatStream2AxiStream_2_U0", "Port" : "imgOutput_data"}]},
			{"Name" : "ldata", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["19"], "DependentChan" : "25", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "9", "SubInstance" : "MatStream2AxiStream_2_U0", "Port" : "ldata"}]},
			{"Name" : "rows", "Type" : "None", "Direction" : "I"},
			{"Name" : "cols", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "7", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.Mat2AxiStream_U0.entry_proc_U0", "Parent" : "6",
		"CDFG" : "entry_proc",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "rows", "Type" : "None", "Direction" : "I"},
			{"Name" : "rows_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["9"], "DependentChan" : "16", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "rows_c_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "cols", "Type" : "None", "Direction" : "I"},
			{"Name" : "cols_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["9"], "DependentChan" : "17", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "cols_c_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "8", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.Mat2AxiStream_U0.last_blk_pxl_width_1_U0", "Parent" : "6",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "return_r", "Type" : "None", "Direction" : "O", "DependentProc" : ["9"], "DependentChan" : "18", "DependentChanDepth" : "2", "DependentChanType" : "1"}]},
	{"ID" : "9", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.Mat2AxiStream_U0.MatStream2AxiStream_2_U0", "Parent" : "6", "Child" : ["10", "15"],
		...
		"Port" : [
			{"Name" : "imgOutput_data", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79", "Port" : "imgOutput_data", "Inst_start_state" : "5", "Inst_end_state" : "6"}]},
			{"Name" : "ldata", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["19"], "DependentChan" : "25", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "ldata_blk_n", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79", "Port" : "ldata", "Inst_start_state" : "5", "Inst_end_state" : "6"}]},
			{"Name" : "rows", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["7"], "DependentChan" : "16", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "rows_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "cols_bound_per_npc", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["7"], "DependentChan" : "17", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "cols_bound_per_npc_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "last_blk_width", "Type" : "None", "Direction" : "I", "DependentProc" : ["8"], "DependentChan" : "18", "DependentChanDepth" : "2", "DependentChanType" : "1"}]},
	{"ID" : "10", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.Mat2AxiStream_U0.MatStream2AxiStream_2_U0.grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79", "Parent" : "9", "Child" : ["11", "12", "13", "14"],
	...
	{"ID" : "11", "Level" : "5", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.Mat2AxiStream_U0.MatStream2AxiStream_2_U0.grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79.shl_8ns_4ns_8_2_1_U186", "Parent" : "10"},
	{"ID" : "12", "Level" : "5", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.Mat2AxiStream_U0.MatStream2AxiStream_2_U0.grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79.shl_8ns_3ns_8_2_1_U187", "Parent" : "10"},
	{"ID" : "13", "Level" : "5", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.Mat2AxiStream_U0.MatStream2AxiStream_2_U0.grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79.lshr_8ns_8ns_8_2_1_U188", "Parent" : "10"},
	{"ID" : "14", "Level" : "5", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.Mat2AxiStream_U0.MatStream2AxiStream_2_U0.grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79.flow_control_loop_pipe_sequential_init_U", "Parent" : "10"},
	{"ID" : "15", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.Mat2AxiStream_U0.MatStream2AxiStream_2_U0.mul_16ns_16ns_32_4_1_U200", "Parent" : "9"},
	{"ID" : "16", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.Mat2AxiStream_U0.rows_c_U", "Parent" : "6"},
	{"ID" : "17", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.Mat2AxiStream_U0.cols_c_U", "Parent" : "6"},
	{"ID" : "18", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.Mat2AxiStream_U0.last_blk_width_channel_U", "Parent" : "6"},
	{"ID" : "19", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.AxiStream2Axi_U0", "Parent" : "1", "Child" : ["20"],
		"CDFG" : "AxiStream2Axi",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "ldata", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["6","9"], "DependentChan" : "25", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "20", "SubInstance" : "grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_67", "Port" : "ldata", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "gmem2_blk_n_AW", "Type" : "RtlSignal"},
					{"Name" : "gmem2_blk_n_B", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "20", "SubInstance" : "grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_67", "Port" : "gmem2", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "dout", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["2"], "DependentChan" : "22", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "dout_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "addrbound_read", "Type" : "None", "Direction" : "I", "DependentProc" : ["5"], "DependentChan" : "24", "DependentChanDepth" : "2", "DependentChanType" : "1"}]},
	{"ID" : "20", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.AxiStream2Axi_U0.grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_67", "Parent" : "19", "Child" : ["21"],
	...
	{"ID" : "21", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.AxiStream2Axi_U0.grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_67.flow_control_loop_pipe_sequential_init_U", "Parent" : "20"},
	{"ID" : "22", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.dout_c_U", "Parent" : "1"},
	{"ID" : "23", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.p_channel_U", "Parent" : "1"},
	{"ID" : "24", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.axibound_U", "Parent" : "1"},
	{"ID" : "25", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_74.ldata_U", "Parent" : "1"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "22", "Max" : "32783"}
	, {"Name" : "Interval", "Min" : "22", "Max" : "32783"}
]}
...
set Spec2ImplPortList { 
	...
	dstPtr { ap_fifo {  { dstPtr_dout fifo_data_in 0 64 }  { dstPtr_num_data_valid fifo_status_num_data_valid 0 4 }  { dstPtr_fifo_cap fifo_update 0 4 }  { dstPtr_empty_n fifo_status 0 1 }  { dstPtr_read fifo_port_we 1 1 } } }
	conv_out_c { ap_fifo {  { conv_out_c_din fifo_data_in 1 64 }  { conv_out_c_num_data_valid fifo_status_num_data_valid 0 3 }  { conv_out_c_fifo_cap fifo_update 0 3 }  { conv_out_c_full_n fifo_status 0 1 }  { conv_out_c_write fifo_port_we 1 1 } } }
}
