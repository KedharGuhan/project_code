...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_src_mat_rows_dout { I 32 vector } p_src_mat_rows_num_data_valid { I 3 vector } p_src_mat_rows_fifo_cap { I 3 vector } p_src_mat_rows_empty_n { I 1 bit } p_src_mat_rows_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_src_mat_cols_dout { I 32 vector } p_src_mat_cols_num_data_valid { I 3 vector } p_src_mat_cols_fifo_cap { I 3 vector } p_src_mat_cols_empty_n { I 1 bit } p_src_mat_cols_read { O 1 bit } } \
} "
}
