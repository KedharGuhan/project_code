...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { imgInput_data_din { O 8 vector } imgInput_data_num_data_valid { I 3 vector } imgInput_data_fifo_cap { I 3 vector } imgInput_data_full_n { I 1 bit } imgInput_data_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 67 \
    name imgInput_rows_c \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_imgInput_rows_c \
    op interface \
    ports { imgInput_rows_c_din { O 32 vector } imgInput_rows_c_num_data_valid { I 3 vector } imgInput_rows_c_fifo_cap { I 3 vector } imgInput_rows_c_full_n { I 1 bit } imgInput_rows_c_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 68 \
    name imgInput_cols_c \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_imgInput_cols_c \
    op interface \
    ports { imgInput_cols_c_din { O 32 vector } imgInput_cols_c_num_data_valid { I 3 vector } imgInput_cols_c_fifo_cap { I 3 vector } imgInput_cols_c_full_n { I 1 bit } imgInput_cols_c_write { O 1 bit } } \
} "
}
