...
set C_modelArgMapList {[ 
	{ "Name" : "ldata", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "addrbound_read", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ addrbound_read sc_in sc_lv 15 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "addrbound_read", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "addrbound_read", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "ldata", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0","-1"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_67", "Port" : "ldata", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "gmem2_blk_n_AW", "Type" : "RtlSignal"},
					{"Name" : "gmem2_blk_n_B", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_67", "Port" : "gmem2", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			...
			{"Name" : "addrbound_read", "Type" : "None", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "1"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_67", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_67.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "12", "Max" : "16395"}
	, {"Name" : "Interval", "Min" : "12", "Max" : "16395"}
]}
...
set Spec2ImplPortList { 
	...
	dout { ap_fifo {  { dout_dout fifo_data_in 0 64 }  { dout_num_data_valid fifo_status_num_data_valid 0 3 }  { dout_fifo_cap fifo_update 0 3 }  { dout_empty_n fifo_status 0 1 }  { dout_read fifo_port_we 1 1 } } }
	addrbound_read { ap_none {  { addrbound_read in_data 0 15 } } }
}
