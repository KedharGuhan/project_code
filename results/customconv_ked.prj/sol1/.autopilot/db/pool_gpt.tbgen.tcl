...
set C_modelName {pool_gpt}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem2 int 8 regular {axi_master 0}  }
	{ pool_in int 64 regular {fifo 0}  }
	{ gmem3 int 8 regular {axi_master 1}  }
	{ pool_out int 64 regular {fifo 0}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "conv_out","offset": { "type": "dynamic","port_name": "conv_out","bundle": "control_r"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "pool_in", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "pool_out", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ pool_in_dout sc_in sc_lv 64 signal 1 } 
	{ pool_in_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ pool_in_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ pool_in_empty_n sc_in sc_logic 1 signal 1 } 
	{ pool_in_read sc_out sc_logic 1 signal 1 } 
	...
	{ m_axi_gmem3_WDATA sc_out sc_lv 8 signal 2 } 
	{ m_axi_gmem3_WSTRB sc_out sc_lv 1 signal 2 } 
	...
	{ m_axi_gmem3_RDATA sc_in sc_lv 8 signal 2 } 
	{ m_axi_gmem3_RLAST sc_in sc_logic 1 signal 2 } 
	{ m_axi_gmem3_RID sc_in sc_lv 1 signal 2 } 
	{ m_axi_gmem3_RFIFONUM sc_in sc_lv 11 signal 2 } 
	...
	{ pool_out_dout sc_in sc_lv 64 signal 3 } 
	{ pool_out_num_data_valid sc_in sc_lv 4 signal 3 } 
	{ pool_out_fifo_cap sc_in sc_lv 4 signal 3 } 
	{ pool_out_empty_n sc_in sc_logic 1 signal 3 } 
	{ pool_out_read sc_out sc_logic 1 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "pool_in_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "pool_in", "role": "dout" }} , 
 	{ "name": "pool_in_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "pool_in", "role": "num_data_valid" }} , 
 	{ "name": "pool_in_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "pool_in", "role": "fifo_cap" }} , 
 	{ "name": "pool_in_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "pool_in", "role": "empty_n" }} , 
 	{ "name": "pool_in_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "pool_in", "role": "read" }} , 
 	...
 	{ "name": "pool_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "pool_out", "role": "dout" }} , 
 	{ "name": "pool_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "pool_out", "role": "num_data_valid" }} , 
 	{ "name": "pool_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "pool_out", "role": "fifo_cap" }} , 
 	{ "name": "pool_out_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "pool_out", "role": "empty_n" }} , 
 	{ "name": "pool_out_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "pool_out", "role": "read" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_pool_gpt_Pipeline_VITIS_LOOP_9_1_VITIS_LOOP_10_2_fu_66", "Port" : "gmem2", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "pool_in", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
			...
			{"Name" : "gmem3", "Type" : "MAXI", "Direction" : "O",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_pool_gpt_Pipeline_VITIS_LOOP_9_1_VITIS_LOOP_10_2_fu_66", "Port" : "gmem3", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "pool_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "6", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "pool_out_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_pool_gpt_Pipeline_VITIS_LOOP_9_1_VITIS_LOOP_10_2_fu_66", "Parent" : "0", "Child" : ["2", "3", "4"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_pool_gpt_Pipeline_VITIS_LOOP_9_1_VITIS_LOOP_10_2_fu_66.add_64ns_64ns_64_2_1_U237", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_pool_gpt_Pipeline_VITIS_LOOP_9_1_VITIS_LOOP_10_2_fu_66.add_64ns_64ns_64_2_1_U238", "Parent" : "1"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_pool_gpt_Pipeline_VITIS_LOOP_9_1_VITIS_LOOP_10_2_fu_66.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "16406", "Max" : "16406"}
	, {"Name" : "Interval", "Min" : "16406", "Max" : "16406"}
]}
...
set Spec2ImplPortList { 
	...
	pool_in { ap_fifo {  { pool_in_dout fifo_data_in 0 64 }  { pool_in_num_data_valid fifo_status_num_data_valid 0 3 }  { pool_in_fifo_cap fifo_update 0 3 }  { pool_in_empty_n fifo_status 0 1 }  { pool_in_read fifo_port_we 1 1 } } }
	...
	pool_out { ap_fifo {  { pool_out_dout fifo_data_in 0 64 }  { pool_out_num_data_valid fifo_status_num_data_valid 0 4 }  { pool_out_fifo_cap fifo_update 0 4 }  { pool_out_empty_n fifo_status 0 1 }  { pool_out_read fifo_port_we 1 1 } } }
}
