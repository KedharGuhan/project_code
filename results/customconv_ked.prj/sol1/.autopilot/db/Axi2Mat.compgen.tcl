...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler Filter2d_accel_fifo_w8_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {ldata_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler Filter2d_accel_fifo_w32_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {rows_c_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler Filter2d_accel_fifo_w32_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {cols_c_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler Filter2d_accel_start_for_AxiStream2Mat_U0 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {start_for_AxiStream2Mat_U0_U}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { imgInput_data_din { O 8 vector } imgInput_data_full_n { I 1 bit } imgInput_data_write { O 1 bit } } \
} "
}
