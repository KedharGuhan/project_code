...
set C_modelArgMapList {[ 
	{ "Name" : "addrbound_read", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "dout_1", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ addrbound_read sc_in sc_lv 15 signal 0 } 
	{ dout_1 sc_in sc_lv 64 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dout_1", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "dout_1", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4", "Max" : "16387"}
	, {"Name" : "Interval", "Min" : "4", "Max" : "16387"}
]}
...
set Spec2ImplPortList { 
	...
	dout_1 { ap_none {  { dout_1 in_data 0 64 } } }
