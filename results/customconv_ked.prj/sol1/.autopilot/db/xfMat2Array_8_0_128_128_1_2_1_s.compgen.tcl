...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_dstPtr \
    op interface \
    ports { dstPtr_dout { I 64 vector } dstPtr_num_data_valid { I 4 vector } dstPtr_fifo_cap { I 4 vector } dstPtr_empty_n { I 1 bit } dstPtr_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_conv_out_c \
    op interface \
    ports { conv_out_c_din { O 64 vector } conv_out_c_num_data_valid { I 3 vector } conv_out_c_fifo_cap { I 3 vector } conv_out_c_full_n { I 1 bit } conv_out_c_write { O 1 bit } } \
} "
}
