set moduleName filter2D_Pipeline_VITIS_LOOP_834_1_VITIS_LOOP_835_2
set isTopModule 0
...
set C_modelName {filter2D_Pipeline_VITIS_LOOP_834_1_VITIS_LOOP_835_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 16 regular {axi_master 0}  }
	{ sext_ln834 int 63 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "filter","offset": { "type": "dynamic","port_name": "filter","bundle": "control_r"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln834", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln834", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln834", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln834 { ap_none {  { sext_ln834 in_data 0 63 } } }
