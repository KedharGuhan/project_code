...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler Filter2d_accel_add_64ns_64ns_64_2_1 BINDTYPE {op} TYPE {add} IMPL {fabric} LATENCY 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_pool_out_1 \
    op interface \
    ports { pool_out_1 { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_pool_in_1 \
    op interface \
    ports { pool_in_1 { I 64 vector } } \
} "
}
