...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_dout \
    op interface \
    ports { dout_dout { I 64 vector } dout_num_data_valid { I 3 vector } dout_fifo_cap { I 3 vector } dout_empty_n { I 1 bit } dout_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_addrbound_read \
    op interface \
    ports { addrbound_read { I 15 vector } } \
} "
}
