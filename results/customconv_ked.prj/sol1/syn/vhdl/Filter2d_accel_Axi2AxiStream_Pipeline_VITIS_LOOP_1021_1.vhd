...
entity Filter2d_accel_Axi2AxiStream_Pipeline_VITIS_LOOP_1021_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Filter2d_accel_Axi2AxiStream_Pipeline_VITIS_LOOP_1021_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln1021_fu_100_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal gmem0_addr_read_reg_139 : STD_LOGIC_VECTOR (7 downto 0);
    signal c_fu_64 : STD_LOGIC_VECTOR (14 downto 0) := "000000000000000";
    signal c_2_fu_106_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_c_1 : STD_LOGIC_VECTOR (14 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln1021_fu_100_p2 = ap_const_lv1_0))) then 
                    c_fu_64 <= c_2_fu_106_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    c_fu_64 <= ap_const_lv15_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                ...
                gmem0_addr_read_reg_139 <= m_axi_gmem0_RDATA;
            end if;
        end if;
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln1021_fu_100_p2)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1021_fu_100_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            ap_sig_allocacmp_c_1 <= ap_const_lv15_0;
        else 
            ap_sig_allocacmp_c_1 <= c_fu_64;
        end if; 
    end process;

    c_2_fu_106_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_c_1) + unsigned(ap_const_lv15_1));
    ...
    icmp_ln1021_fu_100_p2 <= "1" when (ap_sig_allocacmp_c_1 = mul_rows_cols) else "0";
    ...
    ldata_din <= gmem0_addr_read_reg_139;
