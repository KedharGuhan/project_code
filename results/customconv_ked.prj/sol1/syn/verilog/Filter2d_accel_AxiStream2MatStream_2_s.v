...
module Filter2d_accel_AxiStream2MatStream_2_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [7:0] grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58_imgInput_data_din;
wire    grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58_imgInput_data_write;
...
Filter2d_accel_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state7))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if (((grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state7))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign imgInput_data_din = grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58_imgInput_data_din;
...
endmodule //Filter2d_accel_AxiStream2MatStream_2_s
