...
entity Filter2d_accel_AxiStream2MatStream_2_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Filter2d_accel_AxiStream2MatStream_2_s is 
...
attribute shreg_extract : string;
    ...
    signal grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58_imgInput_data_din : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58_imgInput_data_write : STD_LOGIC;
    ...
    component Filter2d_accel_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component Filter2d_accel_mul_32s_32s_32_5_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58 : component Filter2d_accel_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        imgInput_data_din => grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58_imgInput_data_din,
        ...
        imgInput_data_write => grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58_imgInput_data_write);

    mul_32s_32s_32_5_1_U39 : component Filter2d_accel_mul_32s_32s_32_5_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state7))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, ap_block_state1, grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58_ap_done, ap_CS_fsm_state7)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state7 => 
                if (((grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state7))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state7;
                end if;
    ...
    ap_ST_fsm_state7_blk_assign_proc : process(grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58_ap_done)
    begin
    ...
    ap_done_assign_proc : process(ap_done_reg, grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58_ap_done, ap_CS_fsm_state7)
    begin
        if (((grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state7))) then 
    ...
    ap_ready_assign_proc : process(grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58_ap_done, ap_CS_fsm_state7)
    begin
        if (((grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state7))) then 
    ...
    imgInput_data_write_assign_proc : process(grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58_imgInput_data_write, ap_CS_fsm_state7)
    begin
    ...
    ldata_read_assign_proc : process(grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58_ldata_read, ap_CS_fsm_state7)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state7)) then 
            ldata_read <= grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58_ldata_read;
        else 
