...
entity Filter2d_accel_Mat2Axi_Block_entry24_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Filter2d_accel_Mat2Axi_Block_entry24_proc is 
...
begin
    ...
    ap_return_assign_proc : process(ap_CS_fsm_state1, axibound_1, ap_block_state1, ap_return_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return <= axibound_1;
        else 
