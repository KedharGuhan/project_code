...
entity Filter2d_accel_Axi2Mat is
port (
...
architecture behav of Filter2d_accel_Axi2Mat is 
...
attribute shreg_extract : string;
    ...
    signal AxiStream2Mat_U0_imgInput_data_din : STD_LOGIC_VECTOR (7 downto 0);
    ...
    component Filter2d_accel_Axi2AxiStream IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component Filter2d_accel_AxiStream2Mat IS
    port (
    ...
    component Filter2d_accel_fifo_w8_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component Filter2d_accel_fifo_w32_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component Filter2d_accel_start_for_AxiStream2Mat_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    Axi2AxiStream_U0 : component Filter2d_accel_Axi2AxiStream
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    AxiStream2Mat_U0 : component Filter2d_accel_AxiStream2Mat
    port map (
    ...
    ldata_U : component Filter2d_accel_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    rows_c_U : component Filter2d_accel_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    cols_c_U : component Filter2d_accel_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_AxiStream2Mat_U0_U : component Filter2d_accel_start_for_AxiStream2Mat_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
