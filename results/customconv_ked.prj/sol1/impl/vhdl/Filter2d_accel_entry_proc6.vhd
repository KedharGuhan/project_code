...
entity Filter2d_accel_entry_proc6 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Filter2d_accel_entry_proc6 is 
...
begin
    ...
    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, dout_c_full_n)
    begin
                ap_block_state1 <= ((ap_start = ap_const_logic_0) or (dout_c_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
    ...
    dout_c_write_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
