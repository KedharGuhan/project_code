...
entity Filter2d_accel_AxiStream2Axi_Pipeline_MMIterOutLoop2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Filter2d_accel_AxiStream2Axi_Pipeline_MMIterOutLoop2 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln1379_fu_96_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln1379_fu_102_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal add_ln1379_reg_129 : STD_LOGIC_VECTOR (14 downto 0);
    signal ldata_read_reg_139 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                add_ln1379_reg_129 <= add_ln1379_fu_102_p2;
                ap_loop_exit_ready_pp0_iter1_reg <= ap_loop_exit_ready;
                ldata_read_reg_139 <= ldata_dout;
            end if;
        end if;
    end process;
    ...
    add_ln1379_fu_102_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_3) + unsigned(ap_const_lv15_1));
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(ldata_empty_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= (ldata_empty_n = ap_const_logic_0);
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln1379_fu_96_p2)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1379_fu_96_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    ap_sig_allocacmp_i_3_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, add_ln1379_reg_129, i_fu_58, ap_loop_init)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then
            if ((ap_loop_init = ap_const_logic_1)) then 
                ...
                ap_sig_allocacmp_i_3 <= add_ln1379_reg_129;
            else 
    ...
    icmp_ln1379_fu_96_p2 <= "1" when (ap_sig_allocacmp_i_3 = addrbound_read) else "0";

    ldata_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ldata_empty_n, ap_block_pp0_stage0)
    begin
    ...
    ldata_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
    ...
    m_axi_gmem2_WDATA <= ldata_read_reg_139;
