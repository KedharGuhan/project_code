...
entity Filter2d_accel_MatStream2AxiStream_2_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Filter2d_accel_MatStream2AxiStream_2_s is 
...
attribute shreg_extract : string;
    ...
    signal cols_bound_per_npc_read_reg_142 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal rows_int16_reg_148 : STD_LOGIC_VECTOR (15 downto 0);
    signal strideBased_cols_bound_per_npc_fu_94_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal strideBased_cols_bound_per_npc_reg_153 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal last_blk_width_read_reg_169 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal sub_fu_111_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal sub_reg_174 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal grp_fu_104_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal bound_reg_179 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal grp_fu_104_p1 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal grp_fu_104_p00 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_104_p10 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_ce_reg : STD_LOGIC;

    component Filter2d_accel_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component Filter2d_accel_mul_16ns_16ns_32_4_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79 : component Filter2d_accel_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    mul_16ns_16ns_32_4_1_U200 : component Filter2d_accel_mul_16ns_16ns_32_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 16,
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state7, ap_block_state1, grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_done, ap_CS_fsm_state6, ap_block_state7)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state6 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state6) and (grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_done = ap_const_logic_1))) then
    ...
    ap_ST_fsm_state6_blk_assign_proc : process(grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_done)
    begin
    ...
    ap_block_state7_assign_proc : process(ldata_full_n, icmp_ln1340_fu_124_p2)
    begin
                ap_block_state7 <= ((icmp_ln1340_fu_124_p2 = ap_const_lv1_0) and (ldata_full_n = ap_const_logic_0));
    end process;
    ...
    grp_fu_104_p0 <= grp_fu_104_p00(16 - 1 downto 0);
    grp_fu_104_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(rows_int16_reg_148),32));
    grp_fu_104_p1 <= grp_fu_104_p10(16 - 1 downto 0);
    grp_fu_104_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(strideBased_cols_bound_per_npc_reg_153),32));
    ...
    imgOutput_data_read_assign_proc : process(grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_imgOutput_data_read, ap_CS_fsm_state6)
    begin
    ...
    ldata_blk_n_assign_proc : process(ldata_full_n, ap_CS_fsm_state7, icmp_ln1340_fu_124_p2)
    begin
        if (((icmp_ln1340_fu_124_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state7))) then 
    ...
    ldata_din_assign_proc : process(ap_CS_fsm_state7, icmp_ln1340_fu_124_p2, grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ldata_din, grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_localbuffer_out, ap_CS_fsm_state6, ap_block_state7)
    begin
        if (((ap_const_boolean_0 = ap_block_state7) and (icmp_ln1340_fu_124_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state7))) then 
    ...
    ldata_write_assign_proc : process(ap_CS_fsm_state7, icmp_ln1340_fu_124_p2, grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ldata_write, ap_CS_fsm_state6, ap_block_state7)
    begin
        if (((ap_const_boolean_0 = ap_block_state7) and (icmp_ln1340_fu_124_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state7))) then 
    ...
    sub_fu_111_p2 <= std_logic_vector(unsigned(cols_bound_per_npc_read_reg_142) + unsigned(ap_const_lv32_FFFFFFFF));
end behav;
