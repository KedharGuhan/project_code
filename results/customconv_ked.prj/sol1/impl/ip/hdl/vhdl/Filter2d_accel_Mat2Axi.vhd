...
entity Filter2d_accel_Mat2Axi is
port (
...
architecture behav of Filter2d_accel_Mat2Axi is 
...
attribute shreg_extract : string;
    ...
    signal addrbound_U0_p_channel : STD_LOGIC_VECTOR (14 downto 0);
    signal addrbound_U0_rows : STD_LOGIC_VECTOR (14 downto 0);
    signal addrbound_U0_cols : STD_LOGIC_VECTOR (14 downto 0);
    ...
    signal Mat2Axi_Block_entry24_proc_U0_ap_return : STD_LOGIC_VECTOR (14 downto 0);
    signal axibound_full_n : STD_LOGIC;
    signal Mat2AxiStream_U0_imgOutput_data_read : STD_LOGIC;
    signal Mat2AxiStream_U0_ldata_din : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal AxiStream2Axi_U0_m_axi_gmem2_WDATA : STD_LOGIC_VECTOR (7 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem2_WSTRB : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal axibound_dout : STD_LOGIC_VECTOR (14 downto 0);
    ...
    component Filter2d_accel_entry_proc6 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component Filter2d_accel_addrbound IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component Filter2d_accel_Mat2Axi_Block_entry24_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        axibound_1 : IN STD_LOGIC_VECTOR (14 downto 0);
        ap_return : OUT STD_LOGIC_VECTOR (14 downto 0) );
    end component;


    component Filter2d_accel_Mat2AxiStream IS
    port (
        imgOutput_data_dout : IN STD_LOGIC_VECTOR (7 downto 0);
        imgOutput_data_empty_n : IN STD_LOGIC;
        imgOutput_data_read : OUT STD_LOGIC;
    ...
    component Filter2d_accel_AxiStream2Axi IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component Filter2d_accel_fifo_w64_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component Filter2d_accel_fifo_w15_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component Filter2d_accel_fifo_w8_d2_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc6_U0 : component Filter2d_accel_entry_proc6
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    addrbound_U0 : component Filter2d_accel_addrbound
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Mat2Axi_Block_entry24_proc_U0 : component Filter2d_accel_Mat2Axi_Block_entry24_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Mat2AxiStream_U0 : component Filter2d_accel_Mat2AxiStream
    port map (
    ...
    AxiStream2Axi_U0 : component Filter2d_accel_AxiStream2Axi
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    dout_c_U : component Filter2d_accel_fifo_w64_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    p_channel_U : component Filter2d_accel_fifo_w15_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    axibound_U : component Filter2d_accel_fifo_w15_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ldata_U : component Filter2d_accel_fifo_w8_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    Mat2Axi_Block_entry24_proc_U0_ap_continue <= axibound_full_n;
    ...
    begin
        ...
        vhi_cpy := (others => '0');
        vhi_cpy(5 - 1 downto 0) := ap_const_lv32_F(5 - 1 downto 0);
        v0_cpy := cols;
        if (vlo_cpy(5 - 1 downto 0) > vhi_cpy(5 - 1 downto 0)) then
            vhi_cpy(5-1 downto 0) := std_logic_vector(32-1-unsigned(ap_const_lv32_F(5-1 downto 0)));
        ...
        addrbound_U0_cols <= resvalue(15-1 downto 0);
    end process;

    
    addrbound_U0_rows_proc : process(rows)
    ...
    variable addrbound_U0_rows_i : integer;
    ...
    begin
        ...
        vhi_cpy := (others => '0');
        vhi_cpy(4 - 1 downto 0) := ap_const_lv16_F(4 - 1 downto 0);
        v0_cpy := rows;
        if (vlo_cpy(4 - 1 downto 0) > vhi_cpy(4 - 1 downto 0)) then
            vhi_cpy(4-1 downto 0) := std_logic_vector(16-1-unsigned(ap_const_lv16_F(4-1 downto 0)));
            vlo_cpy(4-1 downto 0) := std_logic_vector(16-1-unsigned(ap_const_lv16_0(4-1 downto 0)));
            for addrbound_U0_rows_i in 0 to 16-1 loop
                v0_cpy(addrbound_U0_rows_i) := rows(16-1-addrbound_U0_rows_i);
            end loop;
        end if;
        ...
        resvalue := res_value and not res_mask;
        addrbound_U0_rows <= resvalue(15-1 downto 0);
    end process;

    ap_done <= AxiStream2Axi_U0_ap_done;
    ap_idle <= ((axibound_empty_n xor ap_const_logic_1) and (p_channel_empty_n xor ap_const_logic_1) and entry_proc6_U0_ap_idle and addrbound_U0_ap_idle and Mat2Axi_Block_entry24_proc_U0_ap_idle and Mat2AxiStream_U0_ap_idle and AxiStream2Axi_U0_ap_idle);
