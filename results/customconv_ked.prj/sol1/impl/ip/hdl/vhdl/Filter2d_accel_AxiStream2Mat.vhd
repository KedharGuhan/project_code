...
entity Filter2d_accel_AxiStream2Mat is
port (
...
architecture behav of Filter2d_accel_AxiStream2Mat is 
...
attribute shreg_extract : string;
    ...
    signal entry_proc5_U0_rows_read : STD_LOGIC;
    signal entry_proc5_U0_rows_c_din : STD_LOGIC_VECTOR (31 downto 0);
    signal entry_proc5_U0_rows_c_write : STD_LOGIC;
    signal entry_proc5_U0_cols_read : STD_LOGIC;
    signal entry_proc5_U0_cols_c_din : STD_LOGIC_VECTOR (31 downto 0);
    signal entry_proc5_U0_cols_c_write : STD_LOGIC;
    ...
    signal AxiStream2MatStream_2_U0_imgInput_data_din : STD_LOGIC_VECTOR (7 downto 0);
    signal AxiStream2MatStream_2_U0_imgInput_data_write : STD_LOGIC;
    ...
    signal last_blk_width_channel_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal last_blk_width_channel_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    component Filter2d_accel_entry_proc5 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component Filter2d_accel_last_blk_pxl_width IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component Filter2d_accel_AxiStream2MatStream_2_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component Filter2d_accel_fifo_w32_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component Filter2d_accel_fifo_w4_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc5_U0 : component Filter2d_accel_entry_proc5
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    last_blk_pxl_width_U0 : component Filter2d_accel_last_blk_pxl_width
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    AxiStream2MatStream_2_U0 : component Filter2d_accel_AxiStream2MatStream_2_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    rows_c_U : component Filter2d_accel_fifo_w32_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    cols_c_U : component Filter2d_accel_fifo_w32_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    last_blk_width_channel_U : component Filter2d_accel_fifo_w4_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_done <= AxiStream2MatStream_2_U0_ap_done;
    ap_idle <= (last_blk_pxl_width_U0_ap_idle and (last_blk_width_channel_empty_n xor ap_const_logic_1) and entry_proc5_U0_ap_idle and AxiStream2MatStream_2_U0_ap_idle);
    ...
    ap_sync_ready <= (ap_sync_last_blk_pxl_width_U0_ap_ready and ap_sync_entry_proc5_U0_ap_ready);
    cols_read <= entry_proc5_U0_cols_read;
