...
entity Filter2d_accel_xFFilter2Dkernel_Pipeline_COL_LOOP_k_buf_RAM_AUTO_2R1W is 
    generic(
...
architecture rtl of Filter2d_accel_xFFilter2Dkernel_Pipeline_COL_LOOP_k_buf_RAM_AUTO_2R1W is 
...
begin 
    if (clk'event and clk = '1') then
        if (ce1 = '1') then 
            q1_t0 <= ram(CONV_INTEGER(address1_tmp));
        end if;
    end if;
end process;
