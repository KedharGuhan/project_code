...
entity Filter2d_accel_last_blk_pxl_width_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Filter2d_accel_last_blk_pxl_width_1 is 
...
begin
    ...
    return_r_assign_proc : process(ap_CS_fsm_state1, return_r_preg, ap_block_state1)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
