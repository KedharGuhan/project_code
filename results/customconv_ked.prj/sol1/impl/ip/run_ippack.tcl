...
set Library     "hls"
set IPName      "Filter2d_accel"
set Version     "1.0"
set DisplayName "Filter2d_accel"
set Revision    "2113542795"
...
set xo_kernel_name "Filter2d_accel"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/kedhar/Vitis_Libraries/vision/L1/examples/customconv/customconv_ked.prj/sol1"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "/home/kedhar/Vitis_Libraries/vision/L1/examples/customconv/customconv_ked.prj/sol1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {Filter2d_accel_flow_control_loop_pipe_sequential_init
...
set kernel_xo ""
set detect_deadlock_json "Filter2d_accel_message_dict.json"

## Variables
set Top "Filter2d_accel"
set TopNoPrefix "Filter2d_accel"
...
set Interfaces {
    ...
    s_axi_control_r {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_control_r"
        param_prefix "C_S_AXI_CONTROL_R"
        addr_bits "6"
        port_width "AWADDR 6 WDATA 32 WSTRB 4 ARADDR 6 RDATA 32"
        registers {{0x10 img_in_1 W 0x0 "Data signal of img_in" {{0 32 img_in W 0 "Bit 31 to 0 of img_in"}}} {0x14 img_in_2 W 0x0 "Data signal of img_in" {{0 32 img_in W 0 "Bit 63 to 32 of img_in"}}} {0x1c filter_1 W 0x0 "Data signal of filter" {{0 32 filter W 0 "Bit 31 to 0 of filter"}}} {0x20 filter_2 W 0x0 "Data signal of filter" {{0 32 filter W 0 "Bit 63 to 32 of filter"}}} {0x28 conv_out_1 W 0x0 "Data signal of conv_out" {{0 32 conv_out W 0 "Bit 31 to 0 of conv_out"}}} {0x2c conv_out_2 W 0x0 "Data signal of conv_out" {{0 32 conv_out W 0 "Bit 63 to 32 of conv_out"}}} {0x34 maxpool_out_1 W 0x0 "Data signal of maxpool_out" {{0 32 maxpool_out W 0 "Bit 31 to 0 of maxpool_out"}}} {0x38 maxpool_out_2 W 0x0 "Data signal of maxpool_out" {{0 32 maxpool_out W 0 "Bit 63 to 32 of maxpool_out"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control s_axi_control_r m_axi_gmem0 m_axi_gmem1 m_axi_gmem2 m_axi_gmem3"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_gmem0 {
        ...
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control_r"
    }
    m_axi_gmem1 {
        type "native_axim"
        busTypeName "aximm"
...
## System Info
set user_parameters_list {clk_period 3.3 machine 64 combinational 0 latency 16468 II x}
