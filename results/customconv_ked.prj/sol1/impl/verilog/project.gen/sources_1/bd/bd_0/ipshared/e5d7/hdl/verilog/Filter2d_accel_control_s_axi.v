...
// ==============================================================
`timescale 1ns/1ps
module Filter2d_accel_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER          = 6'h08,
    ADDR_ISR          = 6'h0c,
    ADDR_SHIFT_DATA_0 = 6'h10,
    ADDR_SHIFT_CTRL   = 6'h14,
    ADDR_ROWS_DATA_0  = 6'h18,
    ADDR_ROWS_CTRL    = 6'h1c,
    ADDR_COLS_DATA_0  = 6'h20,
    ADDR_COLS_CTRL    = 6'h24,
    WRIDLE            = 2'd0,
    WRDATA            = 2'd1,
    WRRESP            = 2'd2,
    WRRESET           = 2'd3,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_SHIFT_DATA_0)
            int_shift[7:0] <= (WDATA[31:0] & wmask) | (int_shift[7:0] & ~wmask);
    end
end
