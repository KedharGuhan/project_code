...
module Filter2d_accel_AxiStream2Axi_Pipeline_MMIterOutLoop2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [14:0] add_ln1379_fu_102_p2;
reg   [14:0] add_ln1379_reg_129;
reg   [7:0] ldata_read_reg_139;
...
assign add_ln1379_fu_102_p2 = (ap_sig_allocacmp_i_3 + 15'd1);
...
assign icmp_ln1379_fu_96_p2 = ((ap_sig_allocacmp_i_3 == addrbound_read) ? 1'b1 : 1'b0);
...
assign m_axi_gmem2_WDATA = ldata_read_reg_139;
...
endmodule //Filter2d_accel_AxiStream2Axi_Pipeline_MMIterOutLoop2
