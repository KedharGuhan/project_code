...
module Filter2d_accel_Axi2AxiStream_Pipeline_VITIS_LOOP_1021_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln1021_fu_100_p2;
...
reg   [7:0] gmem0_addr_read_reg_139;
reg   [14:0] c_fu_64;
wire   [14:0] c_2_fu_106_p2;
wire    ap_loop_init;
reg   [14:0] ap_sig_allocacmp_c_1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln1021_fu_100_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1021_fu_100_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign c_2_fu_106_p2 = (ap_sig_allocacmp_c_1 + 15'd1);

assign icmp_ln1021_fu_100_p2 = ((ap_sig_allocacmp_c_1 == mul_rows_cols) ? 1'b1 : 1'b0);

assign ldata_din = gmem0_addr_read_reg_139;
...
endmodule //Filter2d_accel_Axi2AxiStream_Pipeline_VITIS_LOOP_1021_1
