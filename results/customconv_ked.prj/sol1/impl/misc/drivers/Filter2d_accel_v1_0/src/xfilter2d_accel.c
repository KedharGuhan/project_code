...
void XFilter2d_accel_Set_img_in(XFilter2d_accel *InstancePtr, u64 Data) {
    ...
    XFilter2d_accel_WriteReg(InstancePtr->Control_r_BaseAddress, XFILTER2D_ACCEL_CONTROL_R_ADDR_IMG_IN_DATA, (u32)(Data));
    XFilter2d_accel_WriteReg(InstancePtr->Control_r_BaseAddress, XFILTER2D_ACCEL_CONTROL_R_ADDR_IMG_IN_DATA + 4, (u32)(Data >> 32));
}
...
u64 XFilter2d_accel_Get_img_in(XFilter2d_accel *InstancePtr) {
    ...
    Data = XFilter2d_accel_ReadReg(InstancePtr->Control_r_BaseAddress, XFILTER2D_ACCEL_CONTROL_R_ADDR_IMG_IN_DATA);
    Data += (u64)XFilter2d_accel_ReadReg(InstancePtr->Control_r_BaseAddress, XFILTER2D_ACCEL_CONTROL_R_ADDR_IMG_IN_DATA + 4) << 32;
    return Data;
}
...
void XFilter2d_accel_Set_filter(XFilter2d_accel *InstancePtr, u64 Data) {
    ...
    XFilter2d_accel_WriteReg(InstancePtr->Control_r_BaseAddress, XFILTER2D_ACCEL_CONTROL_R_ADDR_FILTER_DATA, (u32)(Data));
    XFilter2d_accel_WriteReg(InstancePtr->Control_r_BaseAddress, XFILTER2D_ACCEL_CONTROL_R_ADDR_FILTER_DATA + 4, (u32)(Data >> 32));
}
...
u64 XFilter2d_accel_Get_filter(XFilter2d_accel *InstancePtr) {
    ...
    Data = XFilter2d_accel_ReadReg(InstancePtr->Control_r_BaseAddress, XFILTER2D_ACCEL_CONTROL_R_ADDR_FILTER_DATA);
    Data += (u64)XFilter2d_accel_ReadReg(InstancePtr->Control_r_BaseAddress, XFILTER2D_ACCEL_CONTROL_R_ADDR_FILTER_DATA + 4) << 32;
    return Data;
}
...
void XFilter2d_accel_Set_conv_out(XFilter2d_accel *InstancePtr, u64 Data) {
    ...
    XFilter2d_accel_WriteReg(InstancePtr->Control_r_BaseAddress, XFILTER2D_ACCEL_CONTROL_R_ADDR_CONV_OUT_DATA, (u32)(Data));
    XFilter2d_accel_WriteReg(InstancePtr->Control_r_BaseAddress, XFILTER2D_ACCEL_CONTROL_R_ADDR_CONV_OUT_DATA + 4, (u32)(Data >> 32));
}
...
u64 XFilter2d_accel_Get_conv_out(XFilter2d_accel *InstancePtr) {
    ...
    Data = XFilter2d_accel_ReadReg(InstancePtr->Control_r_BaseAddress, XFILTER2D_ACCEL_CONTROL_R_ADDR_CONV_OUT_DATA);
    Data += (u64)XFilter2d_accel_ReadReg(InstancePtr->Control_r_BaseAddress, XFILTER2D_ACCEL_CONTROL_R_ADDR_CONV_OUT_DATA + 4) << 32;
    return Data;
}
...
void XFilter2d_accel_Set_maxpool_out(XFilter2d_accel *InstancePtr, u64 Data) {
    ...
    XFilter2d_accel_WriteReg(InstancePtr->Control_r_BaseAddress, XFILTER2D_ACCEL_CONTROL_R_ADDR_MAXPOOL_OUT_DATA, (u32)(Data));
    XFilter2d_accel_WriteReg(InstancePtr->Control_r_BaseAddress, XFILTER2D_ACCEL_CONTROL_R_ADDR_MAXPOOL_OUT_DATA + 4, (u32)(Data >> 32));
}
...
u64 XFilter2d_accel_Get_maxpool_out(XFilter2d_accel *InstancePtr) {
    ...
    Data = XFilter2d_accel_ReadReg(InstancePtr->Control_r_BaseAddress, XFILTER2D_ACCEL_CONTROL_R_ADDR_MAXPOOL_OUT_DATA);
    Data += (u64)XFilter2d_accel_ReadReg(InstancePtr->Control_r_BaseAddress, XFILTER2D_ACCEL_CONTROL_R_ADDR_MAXPOOL_OUT_DATA + 4) << 32;
    return Data;
}
